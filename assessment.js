...
message["text"]="a string of whatever I want";
...
var adjustCount = {
  upVote: function(x){return x=x+1},
  downVote: function(x){return x=x-1}
};
...
var myFriends =["Sam", "Mike", "Eric", "Neely"];

// CODE HERE

// #6 Add a fifth friends name to the end of your myFriends array

myFriends.push("Broussard")
...
var myArray = [1, 2, 3, 4];
//DON'T TOUCH THE CODE ABOVE
var myArrayCopy = myArray.copyWithin(0);
...
for(i=0; i<myNumbers.length; i++){
  if(myNumbers[i]%2==0){evensArray.push(myNumbers[i])}
}
return evensArray;
  // CODE HERE
}
...
// CODE HERE --> I think this is the wrong place to code.
var peopleIknow = [
